...
// /**
//  * A logged in action. If there is no user in the session the request is redirected
//  * to the login page
//  */
// object LoggedInAction extends LoggedInActionBuilder[SecuredRequest[_]] {
//   /**
//    * Creates a secured action
//    */
//   def apply[A]() = new LoggedInActionBuilder[A](false, None)
...
//    */
//   def apply[A](ajaxCall: Boolean) = new LoggedInActionBuilder[A](ajaxCall, None)

//   /**
//    * Creates a secured action
//    * @param authorize an Authorize object that checks if the user is authorized to invoke the action
//    */
//   def apply[A](authorize: Authorization) = new LoggedInActionBuilder[A](false, Some(authorize))
...
//    * @param authorize an Authorize object that checks if the user is authorized to invoke the action
//    */
//   def apply[A](ajaxCall: Boolean, authorize: Authorization) = new LoggedInActionBuilder[A](ajaxCall, Some(authorize))
// }

// /**
//  * A builder for logged in actions
//  *
//  * @param ajaxCall a boolean indicating whether this is an ajax call or not
//  * @param authorize an Authorize object that checks if the user is authorized to invoke the action
//  * @tparam A
//  */
// class LoggedInActionBuilder[A](ajaxCall: Boolean = false, authorize: Option[Authorization] = None)
//   extends SecuredActionBuilder[({ type R[A] = SecuredRequest[A] })#R] {
