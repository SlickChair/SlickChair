...
/**
 * Implements the UserServicePlugin required to use the SecureSocial plugin on top
 * of Slick. See http://securesocial.ws/guide/user-service.html for more details.
 */
