...
create table "ASSIGNMENT" ("PAPERID" UUID NOT NULL,"PERSONID" UUID NOT NULL,"ID" UUID NOT NULL,"UPDATEDAT" TIMESTAMP NOT NULL,"UPDATEDBY" TEXT NOT NULL);
...
create table "PERSON" ("FIRSTNAME" TEXT NOT NULL,"LASTNAME" TEXT NOT NULL,"ORGANIZATION" VARCHAR(254) NOT NULL,"ROLE" INTEGER NOT NULL,"EMAIL" TEXT NOT NULL,"ID" UUID NOT NULL,"UPDATEDAT" TIMESTAMP NOT NULL,"UPDATEDBY" TEXT NOT NULL);
