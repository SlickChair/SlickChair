...
create table "AUTHORS" ("PAPERID" INTEGER NOT NULL,"POSITION" INTEGER NOT NULL,"FIRSTNAME" VARCHAR(254) NOT NULL,"LASTNAME" VARCHAR(254) NOT NULL,"ORGANIZATION" VARCHAR(254) NOT NULL,"EMAIL" VARCHAR(254) NOT NULL);
alter table "AUTHORS" add constraint "AUTHORS_PK" primary key("PAPERID","POSITION");
create table "Files" ("ID" SERIAL NOT NULL PRIMARY KEY,"NAME" VARCHAR(254) NOT NULL,"SIZE" BIGINT NOT NULL,"UPLOADED" TIMESTAMP NOT NULL,"DATA" BYTEA NOT NULL);
create table "MEMBERS" ("id" SERIAL NOT NULL PRIMARY KEY,"email" VARCHAR(254) NOT NULL,"firstlogindate" TIMESTAMP NOT NULL,"lastlogindate" TIMESTAMP NOT NULL,"role" INTEGER NOT NULL,"firstname" VARCHAR(254) NOT NULL,"lastname" VARCHAR(254) NOT NULL,"organization" VARCHAR(254),"positiontitle" VARCHAR(254));
create table "PAPERS" ("ID" SERIAL NOT NULL PRIMARY KEY,"CONTACTEMAIL" VARCHAR(254) NOT NULL,"SUBMISSIONDATE" TIMESTAMP NOT NULL,"LASTUPDATE" TIMESTAMP NOT NULL,"ACCEPTED" BOOLEAN,"TITLE" VARCHAR(254) NOT NULL,"FORMAT" INTEGER NOT NULL,"KEYWORDS" VARCHAR(254) NOT NULL,"ABSTRCT" VARCHAR(254) NOT NULL,"FILEID" INTEGER);
create table "TOPICS" ("ID" SERIAL NOT NULL PRIMARY KEY,"NAME" VARCHAR(254) NOT NULL,"DESCRIPTION" VARCHAR(254) NOT NULL);
...
create table "SECURE_SOCIAL_USERS" ("UID" VARCHAR(254) NOT NULL,"PID" VARCHAR(254) NOT NULL,"EMAIL" VARCHAR(254) NOT NULL,"FIRSTNAME" VARCHAR(254) NOT NULL,"LASTNAME" VARCHAR(254) NOT NULL,"AUTHMETHOD" VARCHAR(254) NOT NULL,"HASHER" VARCHAR(254),"PASSWORD" VARCHAR(254),"SALT" VARCHAR(254));
