...
create table "PAPERS" ("id" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"contactemail" VARCHAR NOT NULL,"submissiondate" TIMESTAMP NOT NULL,"lastupdate" TIMESTAMP NOT NULL,"accepted" BOOLEAN,"title" VARCHAR NOT NULL,"format" INTEGER NOT NULL,"keywords" VARCHAR NOT NULL,"abstrct" VARCHAR NOT NULL,"data" BLOB);
