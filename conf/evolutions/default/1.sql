...
create table "PAPERDECISION" ("PAPERID" OTHER NOT NULL,"DECISION" INTEGER NOT NULL,"ID" OTHER NOT NULL,"UPDATEDAT" TIMESTAMP NOT NULL,"UPDATEDBY" TEXT NOT NULL);
