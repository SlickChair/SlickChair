...
create table "ASSIGNMENT" ("PAPERID" OTHER NOT NULL,"PERSONID" OTHER NOT NULL,"VALUE" BOOLEAN NOT NULL,"ID" OTHER NOT NULL,"UPDATEDAT" TIMESTAMP NOT NULL,"UPDATEDBY" TEXT NOT NULL);
...
create table "PAPER" ("TITLE" TEXT NOT NULL,"FORMAT" INTEGER NOT NULL,"KEYWORDS" TEXT NOT NULL,"ABSTRCT" TEXT NOT NULL,"nAuthors" INTEGER NOT NULL,"FILE" OTHER,"WITHDRAWN" BOOLEAN NOT NULL,"ID" OTHER NOT NULL,"UPDATEDAT" TIMESTAMP NOT NULL,"UPDATEDBY" TEXT NOT NULL);
create table "PAPERAUTHOR" ("PAPERID" OTHER NOT NULL,"PERSONID" OTHER NOT NULL,"POSITION" INTEGER NOT NULL,"ID" OTHER NOT NULL,"UPDATEDAT" TIMESTAMP NOT NULL,"UPDATEDBY" TEXT NOT NULL);
create table "PAPERDECISION" ("PAPERID" OTHER NOT NULL,"VALUE" INTEGER NOT NULL,"ID" OTHER NOT NULL,"UPDATEDAT" TIMESTAMP NOT NULL,"UPDATEDBY" TEXT NOT NULL);
