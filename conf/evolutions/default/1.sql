...
alter table "AUTHOR" add constraint "pkauthors" primary key("ID","UPDATEDAT");
...
create table "PERSON" ("ID" TEXT NOT NULL,"UPDATEDAT" TIMESTAMP NOT NULL,"UPDATEDBY" TEXT NOT NULL,"FIRSTNAME" TEXT NOT NULL,"LASTNAME" TEXT NOT NULL,"ORGANIZATION" VARCHAR,"ROLE" INTEGER NOT NULL,"EMAIL" TEXT NOT NULL);
alter table "PERSON" add constraint "pkpersons" primary key("ID","UPDATEDAT");
...
create table "TOPIC" ("ID" TEXT NOT NULL,"UPDATEDAT" TIMESTAMP NOT NULL,"UPDATEDBY" TEXT NOT NULL,"NAME" TEXT NOT NULL,"DESCRIPTION" TEXT NOT NULL);

# --- !Downs

alter table "AUTHOR" drop constraint "pkauthors";
drop table "AUTHOR";
drop table "COMMENT";
drop table "EMAIL";
drop table "FILE";
...
alter table "PERSON" drop constraint "pkpersons";
drop table "PERSON";
drop table "REVIEW";
drop table "TOPIC";
