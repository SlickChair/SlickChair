...
create table "MEMBERS" ("ID" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"EMAIL" TEXT NOT NULL,"FIRSTLOGINDATE" TIMESTAMP NOT NULL,"LASTLOGINDATE" TIMESTAMP NOT NULL,"ROLE" INTEGER NOT NULL,"FIRSTNAME" TEXT NOT NULL,"LASTNAME" TEXT NOT NULL,"ORGANIZATION" TEXT NOT NULL);
...
create table "SECURE_SOCIAL_TOKENS" ("UUID" TEXT NOT NULL PRIMARY KEY,"EMAIL" TEXT NOT NULL,"CREATIONTIME" TIMESTAMP NOT NULL,"EXPIRATIONTIME" TIMESTAMP NOT NULL,"ISSIGNUP" BOOLEAN NOT NULL);
create table "SECURE_SOCIAL_USERS" ("UID" TEXT NOT NULL,"PID" TEXT NOT NULL,"EMAIL" TEXT NOT NULL,"FIRSTNAME" TEXT NOT NULL,"LASTNAME" TEXT NOT NULL,"AUTHMETHOD" TEXT NOT NULL,"HASHER" VARCHAR,"PASSWORD" VARCHAR,"SALT" VARCHAR);
...
create table "SENTMAILS" ("ID" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"SENT" TIMESTAMP NOT NULL,"TO" TEXT NOT NULL,"SUBJECT" TEXT NOT NULL,"BODY" TEXT NOT NULL);
