...
create table "CONFIGURATION" ("NAME" TEXT NOT NULL,"CHAIRROLES" BOOLEAN NOT NULL,"CHAIRASSIGNMENT" BOOLEAN NOT NULL,"CHAIRDECISION" BOOLEAN NOT NULL,"PCMEMBERBID" BOOLEAN NOT NULL,"PCMEMBERREVIEW" BOOLEAN NOT NULL,"PCMEMBERCOMMENT" BOOLEAN NOT NULL,"AUTHORNEWSUBMISSION" BOOLEAN NOT NULL,"AUTHOREDITSUBMISSION" BOOLEAN NOT NULL,"ALWAYSENABLED" BOOLEAN NOT NULL,"ID" UUID NOT NULL,"UPDATEDAT" TIMESTAMP NOT NULL,"UPDATEDBY" TEXT NOT NULL);
