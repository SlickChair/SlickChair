...
create table "MEMBERS" ("ID" SERIAL NOT NULL PRIMARY KEY,"EMAIL" TEXT NOT NULL,"INVITEDAS" TEXT NOT NULL,"FIRSTLOGINDATE" TIMESTAMP NOT NULL,"LASTLOGINDATE" TIMESTAMP NOT NULL,"ROLE" INTEGER NOT NULL,"FIRSTNAME" TEXT NOT NULL,"LASTNAME" TEXT NOT NULL);
...
create table "COMMENTS" ("ID" SERIAL NOT NULL PRIMARY KEY,"PAPERID" INTEGER NOT NULL,"MEMBERID" INTEGER NOT NULL,"SUBMISSIONDATE" TIMESTAMP NOT NULL,"CONTENT" TEXT NOT NULL);
...
create table "SENT_EMAILS" ("ID" SERIAL NOT NULL PRIMARY KEY,"TO" TEXT NOT NULL,"SUBJECT" TEXT NOT NULL,"BODY" TEXT NOT NULL,"SENT" TIMESTAMP NOT NULL);
